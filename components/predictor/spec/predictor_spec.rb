...
RSpec.describe Predictor::Predictor do
  ...
  it "predicts teams that have won in the past to win in the future" do
    game = OpenStruct.new first_team_id: @team1.id, second_team_id: @team2.id, winning_team: 1
  ...
  it "changes predictions based on games learned" do
    game1 = OpenStruct.new first_team_id: @team1.id, second_team_id: @team2.id, winning_team: 1
    game2 = OpenStruct.new first_team_id: @team1.id, second_team_id: @team2.id, winning_team: 2
    game3 = OpenStruct.new first_team_id: @team1.id, second_team_id: @team2.id, winning_team: 2
